...
- Модуль генерации файла `Proc_IO.txt` для блока инициализации/обработки RTD, генерации токов линий (`AI/DO`), считывания состояний линий (`DI/DO`) и инициализации фазировки.
